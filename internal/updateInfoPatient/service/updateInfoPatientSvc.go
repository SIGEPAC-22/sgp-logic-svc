...
func (u UpdateInfoPatientService) UpdateInfoPatientSvc(ctx context.Context, Id string, firstName string, secondName string, lastFirstName string, lastSecondName string, dateBirth string, documentType string, documentNumber string, cellphoneNumber string, phoneNumber string, responsibleFamily string, responsibleFamilyPhoneNumber string, department string, country string, patientSex string) (updateInfoPatient.UpdateInfoPatientResponse, error) {
	...
	idPatientSex, _ := strconv.Atoi(patientSex)
	...
	resp, err := u.repoDB.UpdateInfoPatientRepo(ctx, idConvert, firstName, secondName, lastFirstName, lastSecondName, dateBirth, idDocumentType, documentNumber, cellphoneNumber, phoneNumber, responsibleFamily, responsibleFamilyPhoneNumber, idDepartment, idCountry, idPatientSex)
	if err != nil {
